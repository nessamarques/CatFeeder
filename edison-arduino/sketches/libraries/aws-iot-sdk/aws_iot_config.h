...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST		"a21mlh507sakvq.iot.us-east-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT		8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID		"giohji-edison2" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME		"giohji-edison" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME	"root.pem" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME	"b2dffb396b-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME	"b2dffb396b-private.pem.key" ///< Device private key filename
// =================================================
...
// Define the desired login levels, used to enable the IOT_ERROR, IOT_WARN,
// IOT_INFO, and IOT_DEBUG macros defined in the './aws_iot_log.h' file.
#define ENABLE_IOT_ERROR 1
#define ENABLE_IOT_WARN 1
#define ENABLE_IOT_INFO 1
